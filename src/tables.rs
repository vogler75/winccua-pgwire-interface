    ...
    pub fn get_schema(&self) -> Vec<(&'static str, Type)> {
        match self {
            ...
            Self::ActiveAlarms => vec![
                ...
                ("raise_time", Type::TIMESTAMPTZ),
                ("acknowledgment_time", Type::TIMESTAMPTZ),
                ("clear_time", Type::TIMESTAMPTZ),
                ("reset_time", Type::TIMESTAMPTZ),
                ("modification_time", Type::TIMESTAMPTZ),
                ("state", Type::TEXT),
                ("priority", Type::INT4),
