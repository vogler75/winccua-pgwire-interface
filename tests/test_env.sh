...
# Server connection
export PGHOST="linux0"          # e.g., "192.168.1.100" or "localhost"
export PGPORT="5432"                      # PostgreSQL port

# Authentication
export PGUSER="username1"             # e.g., "testuser", "admin"
export PGPASSWORD="password1"         # e.g., "password1", "secretpass"
...
echo -e "${BLUE}   ./run_parallel_tests.sh -l 0    ${YELLOW}# Infinite stress test${NC}"
